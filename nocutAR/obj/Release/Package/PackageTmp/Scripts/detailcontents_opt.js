...
$(document).ready(function () {
    ...
    $('#pdf_file').bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#pdf_file").val().substr($("#pdf_file").val().length - 3)).toLowerCase();
        if (imgExtension != 'pdf') {
        ...
        $.ajax({
            url: 'PostUpload.aspx?type=12&content_id=' + CONTENT_ID,
            type: "post",
            data: data,
            // cache: false,
            processData: false,
            ...
            success: function (data, textStatus, jqXHR) {
                $("#hdPdfName").val(data.split(";")[1]);
                $("#hdPdfSize").val(size);
                $("#hdPdfPageCount").val(data.split(";")[2]);
                setTimeout(function () {
                    var element = "";
                    for (i = 0; i < data.split(";")[2]; i++) {
                        element += '<td width="100" height="120">';
                        element += '<table cellpadding="0" cellspacing="0" style="border-collapse: collapse;" width="100" align="center">';
                        element += '<tbody><tr><td width="100" height="120" align="center" style="border-width: 1; border-color: rgb(68,68,68);border-style: solid;">';
                        element += '<img id="cat' + i + '" alt="catalog_preview" src="/uploads/pdf/' + data.split(";")[1] + '/' + (i + 1) + '.png' + '" style="height:100%; width: 100%;">';
                        element += '</td></tr></tbody>';
                        element += '</table></td>';
                    }
                    $("#prev_tbl").html("");
                    jQuery(element).appendTo("#prev_tbl");
                    HideProgress2();
                }, 1000);
            },
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress2();
                alert("pdf 등록과정에 오류가 발생하였습니다.");
            }
        });
    });
    ...
    $('#image_file').bind("change", function () {
        ...
        if (imgExtension != 'jpg' && imgExtension != 'png' && imgExtension != 'gif') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        /***확장자체크***/
    ...
    /*크로마키비디오버튼이미지업로드 처리부분*/
    $("#chromakeybtn_path").bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#chromakeybtn_path").val().substr($("#chromakeybtn_path").val().length - 3)).toLowerCase();
        if (imgExtension != 'png') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        ...
        var file = document.getElementById("chromakeybtn_path");
        var size = file.files[0].size / 1053317.6;
        /*용량제한*/
        if (size > 3) {
            alert("3MB 이하의 파일만 업로드가능합니다.");
    ...
    /*이미지슬라이드버튼이미지업로드 처리부분*/
    $("#slidebtn_path").bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#slidebtn_path").val().substr($("#slidebtn_path").val().length - 3)).toLowerCase();
        if (imgExtension != 'png') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        ...
        var file = document.getElementById("slidebtn_path");
        var size = file.files[0].size / 1053317.6;
        /*용량제한*/
        if (size > 3) {
            alert("3MB 이하의 파일만 업로드가능합니다.");
    ...
    /*PDF뷰어버튼이미지업로드 처리부분*/
    $("#pdfbtn_path").bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#pdfbtn_path").val().substr($("#pdfbtn_path").val().length - 3)).toLowerCase();
        if (imgExtension != 'png') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        ...
        var file = document.getElementById("pdfbtn_path");
        var size = file.files[0].size / 1053317.6;
        /*용량제한*/
        if (size > 3) {
            alert("3MB 이하의 파일만 업로드가능합니다.");
    ...
    /*이미지버튼이미지업로드 처리부분*/
    $("#imagebtn_path").bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#imagebtn_path").val().substr($("#imagebtn_path").val().length - 3)).toLowerCase();
        if (imgExtension != 'png') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        ...
        var file = document.getElementById("imagebtn_path");
        var size = file.files[0].size / 1053317.6;
        /*용량제한*/
        if (size > 3) {
            alert("3MB 이하의 파일만 업로드가능합니다.");
    ...
    /*비디오버튼이미지업로드 처리부분*/
    $("#videobtn_path").bind("change", function () {
        /*확장자체크*/
        var imgExtension = ($("#videobtn_path").val().substr($("#videobtn_path").val().length - 3)).toLowerCase();
        if (imgExtension != 'png') {
            alert("파일형식이 바르지 않습니다.");
            return;
        }
        ...
        var file = document.getElementById("videobtn_path");
        var size = file.files[0].size / 1053317.6;
        /*용량제한*/
        if (size > 3) {
            alert("3MB 이하의 파일만 업로드가능합니다.");
...
function OnVideoApply1() {
    ...
    //실행옵션 type
    var run_opt = 0;
    if ($("#videorun_rd1")[0].checked == true) {
        run_opt = 0;
        if ($("#video_" + index + "_btn").length)
            $("#video_" + index + "_btn").remove();
        if ($("#video_" + index + "_imgbtn").length)
            $("#video_" + index + "_imgbtn").remove();
    }else if ($("#videorun_rd2")[0].checked == true) {
        run_opt = 1;
        if ($("#video_" + index + "_btn").length)
            $("#video_" + index + "_btn").remove();
        if ($("#video_" + index + "_imgbtn").length)
            $("#video_" + index + "_imgbtn").remove();
    } else if ($("#videorun_rd3")[0].checked == true) {
        run_opt = 2;
        ...
        if (!$("#video_" + index + "_btn").length) {
            ...
            $(".tempcontent" + " span").css("color", $("#spVideoPreviewText").css("color"));
            $(".tempcontent" + " span").html($("#spVideoPreviewText").html());

            $(".tempcontent > table").css("background-color", $("#tblVideoPreviewBtn").css("background-color"));

            $(".tempclass").attr("id", "video_" + index + "_btn");
            $("#video_" + index + "_btn").removeClass("tempclass").addClass("dragged_object");

            $(".tempclass").removeClass("tempclass");
            $(".tempcontent").removeClass("tempcontent");

            $("#video_" + index + "_btn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 95, "top": $(objName).position().top + $(objName).height(), "z-index": index });
            $("#video_" + index + "_btn").draggable({
                containment: "parent"
            });
        } else {
            //비디오 재생버튼수정
            $("#video_" + index + "_btn" + " img").attr("src", "img/cam_icon01.png");
            $("#video_" + index + "_btn" + " span").css("color", $("#spVideoPreviewText").css("color"));
            $("#video_" + index + "_btn" + " span").html($("#spVideoPreviewText").html());
            $("#video_" + index + "_btn" + " table").css("background-color", $("#tblVideoPreviewBtn").css("background-color"));
            $("#video_" + index + "_btn").draggable({
                containment: "parent"
            });
        }
    }else if ($("#videorun_rd4")[0].checked == true) {
        run_opt = 3;
        ...
        if (!$("#video_" + index + "_imgbtn").length) {
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        imgbtn_obj += '<img style="width:100%; height:100%" src="' + data + '"></img>';
                        imgbtn_obj += "</div>";
                        jQuery(imgbtn_obj).appendTo("#editframe");

                        $("#temp").attr("id", "video_" + index + "_imgbtn");
                        $("#video_" + index + "_imgbtn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 50, "top": $(objName).position().top + $(objName).height(), "z-index": index });
                        $("#video_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#video_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        });
                        setTimeout(function () {
                            $("#video_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#video_" + index + "_imgbtn").width() / $("#video_" + index + "_imgbtn" + " img").height(),
                    ...
                    error: function (jqXHR, textStatus, errorThrown) {
                        HideProgress();
                        alert("비디오버튼등록과정에 오류가 발생하였습니다.");
                    }
                });
                //파일컨트롤 초기화
                $("#videobtn_path").replaceWith($("#videobtn_path").clone(true));
                isFileChange2 = 0;
            }else {
                alert("비디오버튼이미지를 선택해주십시오.");
                return;
            }
        } else {
            //이미지버튼 수정
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        HideProgress();
                        $("#video_" + index + "_imgbtn img").attr("src", data);
                        $("#video_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#video_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        ...
                        setTimeout(function () {
                            $("#video_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#video_" + index + "_imgbtn" + " img").width() / $("#video_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
    ...
    var btn_mode_index = $("#hdVideoModeIndex").val();
    var btn_color_index = $("#hdVideoColorIndex").val();
    var btn_textcolor_index = $("#hdVideoTextColorIndex").val();
    ...
    if ($("#video_file").val().substr(0, 22) == "http://www.youtube.com") {
        ...
        videoList[index] = { url: $("#video_file").val(), type: val, run_opt: run_opt, objsize: 0, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
    ...
    if (isFileChange) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                videoList[index] = { url: server_url + data, type: val, run_opt: run_opt, objsize: size, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
        ...
        if (videoList[index] != null) {
            ...
            videoList[index] = { url: videoList[index].url, type: val, run_opt: run_opt, objsize: videoList[index].objsize, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
...
function OnLinkVideoApply1() {
    ...
    if ($("#txt_link").val() == '') {
        alert("유튜브 링크를 입력하십시오.");
        return;
    }

    if ($("#txt_link").val().substr(0, 23) == "https://www.youtube.com" && $("#txt_link").val() != $("#hd_link").val()) {
        ShowProgress();
        var link_url = $("#txt_link").val();
        $.ajax({
            url: 'PostUpload.aspx?type=13&content_id=' + CONTENT_ID + '&link_url=' + link_url,
            type: "post",
            processData: false,
            contentType: false,
            success: function (data, textStatus, jqXHR) {
                ...
                linkvideoList[index] = { link_url: $("#hd_link").val(), data_url: data, type: val, run_opt: run_opt, objsize: 0 };
            ...
            error: function (jqXHR, textStatus, errorThrown) {
                HideProgress();
                alert("유튜브비디오 등록과정에 오류가 발생하였습니다.");
            }
        });
    }
    else {
...
function OnLinkVideoApply2() {
    var index = objName.substr(11);
    var val = 0;
    if ($("#linkvideo_rd2")[0].checked == true)
        val = 1;
    else if ($("#linkvideo_rd3")[0].checked == true)
        val = 2;
    if (linkvideoList[index] != null) {
        linkvideoList[index].type = val;
    }
    closePopup();
}

function onChangeVideoColor(color, index) {
    $("#tblVideoPreviewBtn").css("background-color", color);
    $("#tdVideoColorBtn" + index).addClass("clsColorBtnSel");
    $("#hdVideoColorIndex").val(index);
}
function onChangeDefaultVideoBtn(text, index) {
    $("#spVideoPreviewText").html(text);
    $("#tdVideoModeBtn" + index).addClass("clsColorBtnSel");
    $("#hdVideoModeIndex").val(index);
}

function onChangePdfColor(color, index) {
    $("#tblPdfPreviewBtn").css("background-color", color);
    $("#tdPdfColorBtn" + index).addClass("clsColorBtnSel");
    $("#hdPdfColorIndex").val(index);
}
function onChangeDefaultPdfBtn(text, index) {
    $("#spPdfPreviewText").html(text);
    $("#tdPdfModeBtn" + index).addClass("clsColorBtnSel");
    $("#hdPdfModeIndex").val(index);
}

function onChangeImageColor(color, index) {
    $("#tblImagePreviewBtn").css("background-color", color);
    $("#tdImageColorBtn" + index).addClass("clsColorBtnSel");
    $("#hdImageColorIndex").val(index);
}
function onChangeDefaultImageBtn(text, index) {
    $("#spImagePreviewText").html(text);
    $("#tdImageModeBtn" + index).addClass("clsColorBtnSel");
    $("#hdImageModeIndex").val(index);
}

function onChangeSlideColor(color, index) {
    $("#tblSlidePreviewBtn").css("background-color", color);
    $("#tdSlideColorBtn" + index).addClass("clsColorBtnSel");
    $("#hdSlideColorIndex").val(index);
}
function onChangeDefaultSlideBtn(text, index) {
    $("#spSlidePreviewText").html(text);
    $("#tdSlideModeBtn" + index).addClass("clsColorBtnSel");
    $("#hdSlideModeIndex").val(index);
}

function onChangeChromakeyColor(color, index) {
    $("#tblChromakeyPreviewBtn").css("background-color", color);
    $("#tdChromakeyColorBtn" + index).addClass("clsColorBtnSel");
    $("#hdChromakeyColorIndex").val(index);
}
function onChangeDefaultChromakeyBtn(text, index) {
    $("#spChromakeyPreviewText").html(text);
    $("#tdChromakeyModeBtn" + index).addClass("clsColorBtnSel");
    $("#hdChromakeyModeIndex").val(index);
}
...
function OnImageApply1() {
    ...
    //실행옵션 type
    var run_opt = 0;
    if ($("#imagerun_rd1")[0].checked == true) {
        run_opt = 0;
        if ($("#img_" + index + "_btn").length)
            $("#img_" + index + "_btn").remove();
        if ($("#img_" + index + "_imgbtn").length)
            $("#img_" + index + "_imgbtn").remove();
    } else if ($("#imagerun_rd2")[0].checked == true) {
        run_opt = 1;
        ...
        if (!$("#img_" + index + "_btn").length) {
            ...
            $(".tempcontent" + " span").css("color", $("#spImagePreviewText").css("color"));
            $(".tempcontent" + " span").html($("#spImagePreviewText").html());

            $(".tempcontent > table").css("background-color", $("#tblImagePreviewBtn").css("background-color"));

            $(".tempclass").attr("id", "img_" + index + "_btn");
            $("#img_" + index + "_btn").removeClass("tempclass").addClass("dragged_object");

            $(".tempclass").removeClass("tempclass");
            $(".tempcontent").removeClass("tempcontent");

            $("#img_" + index + "_btn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 95, "top": $(objName).position().top + $(objName).height(), "z-index": index });
            $("#img_" + index + "_btn").draggable({
                containment: "parent"
            });
        } else {
            //비디오 재생버튼수정
            $("#img_" + index + "_btn" + " img").attr("src", "img/cam_icon02.png");
            $("#img_" + index + "_btn" + " span").css("color", $("#spImagePreviewText").css("color"));
            $("#img_" + index + "_btn" + " span").html($("#spImagePreviewText").html());
            $("#img_" + index + "_btn" + " table").css("background-color", $("#tblImagePreviewBtn").css("background-color"));
            $("#img_" + index + "_btn").draggable({
                containment: "parent"
            });
        }
    } else if ($("#imagerun_rd3")[0].checked == true) {
        run_opt = 2;
        ...
        if (!$("#img_" + index + "_imgbtn").length) {
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        $("#temp").attr("id", "img_" + index + "_imgbtn");
                        $("#img_" + index + "_imgbtn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 50, "top": $(objName).position().top + $(objName).height(), "z-index": index });
                        $("#img_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#img_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        });
                        setTimeout(function () {
                            $("#img_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#img_" + index + "_imgbtn").width() / $("#img_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        HideProgress();
                        alert("이미지버튼등록과정에 오류가 발생하였습니다.");
                    }
                });
                //파일컨트롤 초기화
                $("#imagebtn_path").replaceWith($("#imagebtn_path").clone(true));
                isFileChange2 = 0;
            } else {
                alert("이미지버튼이미지를 선택해주십시오.");
                return;
            }
        } else {
            //이미지버튼 수정
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        HideProgress();
                        $("#img_" + index + "_imgbtn img").attr("src", data);
                        $("#img_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#img_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        ...
                        setTimeout(function () {
                            $("#img_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#img_" + index + "_imgbtn" + " img").width() / $("#img_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
    ...
    var btn_mode_index = $("#hdImageModeIndex").val();
    var btn_color_index = $("#hdImageColorIndex").val();
    var btn_textcolor_index = $("#hdImageTextColorIndex").val();
    ...
    if (isFileChange) {
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                //setTimeout(function () {
                    ...
                    //디비에 등록
                    imgList[index] = { url: server_url + data, type: type, objsize: size, run_opt: run_opt, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
        ...
        if (imgList[index] != null) {
            ...
            //디비에 등록
            imgList[index] = { url: imgList[index].url, type: type, objsize: imgList[index].objsize, run_opt: run_opt, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
...
function OnPdfApply() {
    ...
    var name = encodeURIComponent($("#hdPdfName").val());
    if(name == ""){
        alert("pdf파일을 등록해주세요");
        return;
    }

    var size = $("#hdPdfSize").val();
    if (size == "") {
        alert("정확한 pdf파일을 등록해주세요.");
    }

    var pagecount = $("#hdPdfPageCount").val();
    if(pagecount == ""){
        alert("정확한 pdf파일을 등록해주세요.");
        return;
    }
    ...
    if ($("#pdfrun_rd1")[0].checked == true) {
        ...
        $("#temp").css({ "left": 0, "top": $("#markImg").height() });
        $("#temp").css({ "z-index": $(objName).css("z-index") });
        //현재 선택된 오브젝트를 삭제한다.
        $(objName).remove();
        $("#temp").addClass("dragged_object");
        ...
        pdfList[index] = { backurl: "none", name: name, pagecount: pagecount, run_opt: run_opt, objsize: size };

        //패널사건추가
        add_DoubleClickEvent();
        closePopup();

    } else if ($("#pdfrun_rd2")[0].checked == true) {
        run_opt = 1;

        var pos = $(objName).position();
        var title = $("#spPdfPreviewText").html();
        var color = $("#tblPdfPreviewBtn").css("background-color");
        var textcolor = $("#spPdfPreviewText").css("color");
        ...
        var mode_index = $("#hdPdfModeIndex").val();
        var color_index = $("#hdPdfColorIndex").val();
        var textcolor_index = $("#hdPdfTextColorIndex").val();
        ...
        pdfList[index] = { backurl: "none", name: name, pagecount: pagecount, run_opt: run_opt, objsize: size, title: title, mode_index: mode_index, color: color, color_index: color_index, textcolor: textcolor, textcolor_index: textcolor_index };

        //패널사건추가
        add_DoubleClickEvent();
        closePopup();

    } else if ($("#pdfrun_rd3")[0].checked == true) {
        run_opt = 2;
        if (isFileChange2) {
            var file = document.getElementById("pdfbtn_path");
            var size = file.files[0].size / 1053317.6;
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    ...
                    var pos = $(objName).position();
                    var element = '<div id="temp" style="min-width:98px; width: 100px; height:auto; position:absolute">';
                    element += '<img style="width:100px; height:auto;" src="' + data + '"></img>';
                    //패널 추가
                    element += panel_obj;

                    jQuery(element).appendTo("#editframe");
                    if (pdfList[index] != null) {
                        $("#temp").css({ "width": $(objName).width(), "height": $(objName).height() });
                    }
                    $("#temp").css({ "left": pos.left, "top": pos.top });
                    $("#temp").css({ "z-index": $(objName).css("z-index") });
                    ...
                    //디비에 등록
                    pdfList[index] = { backurl: server_url + data, name: name, pagecount: pagecount, run_opt: run_opt, objsize: size };
                ...
                error: function (jqXHR, textStatus, errorThrown) {
                    HideProgress();
                    alert("pdf버튼등록과정에 오류가 발생하였습니다.");
                }
            });
            //파일컨트롤 초기화
            $("#pdfbtn_path").replaceWith($("#pdfbtn_path").clone(true));
            isFileChange2 = 0;
        }
        else {
            if (pdfList[index] != null) {
                if (pdfList[index].backurl == "none") {
                    alert("pdf버튼이미지를 등록해주세요.");
                    return;
                }
                pos = $(objName).position();
                var element = '<div id="temp" style="min-width:98px; width: 100px; height:auto; position:absolute">';
                element += '<img style="width:100px; height:auto;" src="' + pdfList[index].backurl + '"></img>';
                //패널 추가
                element += panel_obj;
                jQuery(element).appendTo("#editframe");
                $("#temp").css({ "width": $(objName).width(), "height": $(objName).height() });
                ...
                $(objName).remove();
                $("#temp").addClass("dragged_object");
                $("#temp").attr("id", "pdf_" + index);
                //크기조종
                $("#pdf_" + index).draggable({
                    containment: "parent"
                });
                $("#pdf_" + index).resizable({
                    aspectRatio: true,
                    containment: "parent"
                });
                //디비에 등록
                pdfList[index] = { backurl: pdfList[index].backurl, name: name, pagecount: pagecount, run_opt: run_opt, objsize: size };
...
function OnSlideApply1() {
    ...
    var playtype = 0;
    var timediff = 0;
    if ($('.rdoSlidePlayType').find('input')[0].checked) {
        playtype = 0;
        timediff = $('#selTime').val();
    } else if ($('.rdoSlidePlayType').find('input')[1].checked) {
        playtype = 1;
        timediff = 0;
    }  
    ...
    //실행옵션 type
    var run_opt = 0;
    if ($("#sliderun_rd1")[0].checked == true) {
        run_opt = 0;
        if ($("#slide_" + index + "_btn").length)
            $("#slide_" + index + "_btn").remove();
        if ($("#slide_" + index + "_imgbtn").length)
            $("#slide_" + index + "_imgbtn").remove();
    } else if ($("#sliderun_rd2")[0].checked == true) {
        run_opt = 1;
        ...
        if (!$("#slide_" + index + "_btn").length) {
            ...
            $(".tempcontent" + " span").css("color", $("#spSlidePreviewText").css("color"));
            $(".tempcontent" + " span").html($("#spSlidePreviewText").html());

            $(".tempcontent > table").css("background-color", $("#tblSlidePreviewBtn").css("background-color"));

            $(".tempclass").attr("id", "slide_" + index + "_btn");
            $("#slide_" + index + "_btn").removeClass("tempclass").addClass("dragged_object");

            $(".tempclass").removeClass("tempclass");
            $(".tempcontent").removeClass("tempcontent");

            $("#slide_" + index + "_btn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 95, "top": $(objName).position().top + $(objName).height(), "z-index": index });
            $("#slide_" + index + "_btn").draggable({
                containment: "parent"
            });
        } else {
            //비디오 재생버튼수정
            $("#slide_" + index + "_btn" + " img").attr("src", "img/cam_icon08.png");
            $("#slide_" + index + "_btn" + " span").css("color", $("#spSlidePreviewText").css("color"));
            $("#slide_" + index + "_btn" + " span").html($("#spSlidePreviewText").html());
            $("#slide_" + index + "_btn" + " table").css("background-color", $("#tblSlidePreviewBtn").css("background-color"));
            $("#slide_" + index + "_btn").draggable({
                containment: "parent"
            });
        }
    } else if ($("#sliderun_rd3")[0].checked == true) {
        run_opt = 2;
        ...
        if (!$("#slide_" + index + "_imgbtn").length) {
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        $("#temp").attr("id", "slide_" + index + "_imgbtn");
                        $("#slide_" + index + "_imgbtn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 50, "top": $(objName).position().top + $(objName).height(), "z-index": index });
                        $("#slide_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#slide_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        });
                        setTimeout(function () {
                            $("#slide_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#slide_" + index + "_imgbtn").width() / $("#slide_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
                ...
                //파일컨트롤 초기화
                $("#slidebtn_path").replaceWith($("#slidebtn_path").clone(true));
                isFileChange2 = 0;
            } else {
                alert("이미지버튼이미지를 선택해주십시오.");
                return;
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        HideProgress();
                        $("#slide_" + index + "_imgbtn img").attr("src", data);
                        $("#slide_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#slide_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        ...
                        setTimeout(function () {
                            $("#slide_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#slide_" + index + "_imgbtn" + " img").width() / $("#slide_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
    ...
    var btn_mode_index = $("#hdSlideModeIndex").val();
    var btn_color_index = $("#hdSlideColorIndex").val();
    var btn_textcolor_index = $("#hdSlideTextColorIndex").val();
    ...
    slideList[index] = { type: type, showtype: showtype, playtype: playtype, timediff: timediff, prev_count: prevArray.length,
        url1: prevArray[0],
        url2: prevArray[1],
        url3: prevArray[2],
        url4: prevArray[3],
        ...
        objsize: objsize,
        run_opt: run_opt,
        btn_mode_index: btn_mode_index,
        btn_color_index: btn_color_index,
        btn_textcolor_index: btn_textcolor_index 
    };
    //패널사건추가
    add_DoubleClickEvent();
    /***새로 추가 및 수정***/
...
function OnChromakeyApply() {
    ...
    //실행옵션 type
    var run_opt = 0;
    if ($("#chromakeyrun_rd1")[0].checked == true) {
        run_opt = 0;
        if ($("#chromakey_" + index + "_btn").length)
            $("#chromakey_" + index + "_btn").remove();
        if ($("#chromakey_" + index + "_imgbtn").length)
            $("#chromakey_" + index + "_imgbtn").remove();
    } else if ($("#chromakeyrun_rd2")[0].checked == true) {
        run_opt = 1;
        if ($("#chromakey_" + index + "_btn").length)
            $("#chromakey_" + index + "_btn").remove();
        if ($("#chromakey_" + index + "_imgbtn").length)
            $("#chromakey_" + index + "_imgbtn").remove();
    } else if ($("#chromakeyrun_rd3")[0].checked == true) {
        run_opt = 2;
        if ($("#chromakey_" + index + "_imgbtn").length)
            $("#chromakey_" + index + "_imgbtn").remove();
        if (!$("#chromakey_" + index + "_btn").length) {
            ...
            $(".tempcontent" + " span").css("color", $("#spChromakeyPreviewText").css("color"));
            $(".tempcontent" + " span").html($("#spChromakeyPreviewText").html());

            $(".tempcontent > table").css("background-color", $("#tblChromakeyPreviewBtn").css("background-color"));

            $(".tempclass").attr("id", "chromakey_" + index + "_btn");
            $("#chromakey_" + index + "_btn").removeClass("tempclass").addClass("dragged_object");

            $(".tempclass").removeClass("tempclass");
            $(".tempcontent").removeClass("tempcontent");

            $("#chromakey_" + index + "_btn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 95, "top": $(objName).position().top + $(objName).height(), "z-index": index });
            $("#chromakey_" + index + "_btn").draggable({
                containment: "parent"
            });
        } else {
            //크로마키비디오 재생버튼수정
            $("#chromakey_" + index + "_btn" + " img").attr("src", "img/cam_icon10.png");
            $("#chromakey_" + index + "_btn" + " span").css("color", $("#spChromakeyPreviewText").css("color"));
            $("#chromakey_" + index + "_btn" + " span").html($("#spChromakeyPreviewText").html());
            $("#chromakey_" + index + "_btn" + " table").css("background-color", $("#tblChromakeyPreviewBtn").css("background-color"));
            $("#chromakey_" + index + "_btn").draggable({
                containment: "parent"
            });
        }
    } else if ($("#chromakeyrun_rd4")[0].checked == true) {
        run_opt = 3;
        ...
        if (!$("#chromakey_" + index + "_imgbtn").length) {
            ...
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        ...
                        $("#temp").attr("id", "chromakey_" + index + "_imgbtn");
                        $("#chromakey_" + index + "_imgbtn").css({ "left": $(objName).position().left + $(objName).width() / 2 - 50, "top": $(objName).position().top + $(objName).height(), "z-index": index });
                        $("#chromakey_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#chromakey_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        });
                        setTimeout(function () {
                            $("#chromakey_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#chromakey_" + index + "_imgbtn").width() / $("#chromakey_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
                    error: function (jqXHR, textStatus, errorThrown) {
                        HideProgress();
                        alert("크로마키비디오버튼등록과정에 오류가 발생하였습니다.");
                    }
                });
                //파일컨트롤 초기화
                $("#chromakeybtn_path").replaceWith($("#chromakeybtn_path").clone(true));
                isFileChange2 = 0;
            } else {
                alert("크로마키비디오버튼이미지를 선택해주십시오.");
                return;
            }
        } else {
            //이미지버튼 수정
            if (isFileChange2) {
                ...
                $.ajax({
                    ...
                    success: function (data, textStatus, jqXHR) {
                        HideProgress();
                        $("#chromakey_" + index + "_imgbtn img").attr("src", data);
                        $("#chromakey_" + index + "_imgbtn").addClass("dragged_object");
                        //크기조종
                        $("#chromakey_" + index + "_imgbtn").draggable({
                            containment: "parent"
                        ...
                        setTimeout(function () {
                            $("#chromakey_" + index + "_imgbtn").resizable({
                                aspectRatio: $("#chromakey_" + index + "_imgbtn" + " img").width() / $("#chromakey_" + index + "_imgbtn" + " img").height(),
                                containment: "#editframe"
                            });
                        }, 500);
                    },
    ...
    var btn_mode_index = $("#hdChromakeyModeIndex").val();
    var btn_color_index = $("#hdChromakeyColorIndex").val();
    var btn_textcolor_index = $("#hdChromakeyTextColorIndex").val();
        ...
        $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
                ...
                //setTimeout(function () {
                    ...
                    //디비에 등록
                    chromakeyList[index] = { url: server_url + data, type: type, run_opt: run_opt, objsize: size, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
    ...
    /*수정*/
        ...
        if (isFileChange) {
            ...
            //디비에 등록
            chromakeyList[index] = { url: chromakeyList[index].url, type: type, run_opt: run_opt, objsize: chromakeyList[index].objsize, btn_mode_index: btn_mode_index, btn_color_index: btn_color_index, btn_textcolor_index: btn_textcolor_index };
            closePopup();
        }
    }
    //closePopup();
