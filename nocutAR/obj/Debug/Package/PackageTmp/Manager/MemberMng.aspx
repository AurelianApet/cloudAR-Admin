...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    function OnShowUsedStatus(id, company, markers, usemakers, api_requests, usescans, traffic, usetraffic, hardused, usedhard) {
        ...
        $("#tdUseHard_div").html(usetraffic + "G/ " + traffic + "G");
        $("#tdTraffic_div").html(usedhard + "G/ " + hardused + "G");


        $("#tdScans").css("width", 323 * usescans / api_requests);
        $("#tdUseHard").css("width", 323 * usetraffic / traffic);
        $("#tdTraffic").css("width", 323 * usedhard / hardused);
