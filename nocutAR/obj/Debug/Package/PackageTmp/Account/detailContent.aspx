                                ...
                                <table cellpadding="0" cellspacing="0" align="center" width="476">
                                    ...
                                    <tr>
                                        ...
                                        <td width="361" height="72" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="360">
                                                <tr>
                                                    <td width="69" height="47" id="tdBoardTypeBtn1" class="clsLabel clsBoardType" onclick="onChangeBoardType(0);">
                                                        없음
                                                    </td>
                                                    <td width="71" height="47" id="tdBoardTypeBtn2" class="clsLabel clsBoardType" onclick="onChangeBoardType(1);">
                                                        <img src="img/icon_text01.png" width="38" height="33" border="0">
                                                    </td>
                                                    <td width="71" height="47" id="tdBoardTypeBtn3" class="clsLabel clsBoardType" onclick="onChangeBoardType(2);">
                                                        <img src="img/icon_text02.png" width="38" height="33" border="0">
                                                    </td>
                                                    <td width="70" height="47" id="tdBoardTypeBtn4" class="clsLabel clsBoardType" onclick="onChangeBoardType(3);">
                                    ...
                                    <tr>
                                        ...
                                        <td width="361" height="61" valign="top">
                                            <table cellpadding="0" cellspacing="0" width="350">
                                                <tr>
                                                    <td width="35" height="35" id="tdBoardColorBtn1" class="clsColorBtn" onclick="onChangeBoardColor('#DDDDDD',1);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#DDDDDD">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn2" class="clsColorBtn" onclick="onChangeBoardColor('#999999',2);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#999999">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn3" class="clsColorBtn" onclick="onChangeBoardColor('black',3);">
                                                        <table cellpadding="0" cellspacing="0" align="center">
                                                            <tr>
                                                                <td width="25" height="25" bgcolor="black">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn4" class="clsColorBtn" onclick="onChangeBoardColor('#079DEC',4);">
                                                        <table cellpadding="0" cellspacing="0" align="center">
                                                            <tr>
                                                                <td width="25" height="25" bgcolor="#079DEC">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn5" class="clsColorBtn" onclick="onChangeBoardColor('#1234AB',5);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#1234AB">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn6" class="clsColorBtn" onclick="onChangeBoardColor('red',6);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="red">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn7" class="clsColorBtn" onclick="onChangeBoardColor('#FF7700',7);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#FF7700">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn8" class="clsColorBtn" onclick="onChangeBoardColor('#FFDD00',8);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#FFDD00">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn9" class="clsColorBtn" onclick="onChangeBoardColor('#33AA22',9);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#33AA22">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                                                    ...
                                                    <td width="35" height="35" id="tdBoardColorBtn10" class="clsColorBtn" onclick="onChangeBoardColor('#BB33AA',10);">
                                                        <table cellpadding="0" cellspacing="0" align="center" bgcolor="#BB33AA">
                                                            <tr>
                                                                <td width="25" height="25">
                                                                    &nbsp;
                        ...
                        <tr>
                            <td width="500" height="78" align="right" style="border-width: 1px; border-top-color: rgb(229,233,235);
                                ...
                                <table cellpadding="0" cellspacing="0" align="center" width="466">
                                    <tr>
                                        <td width="466" height="44" align="right">
                                            <input type="hidden" id="hdTextColorTextIndex" value="1"/>
                                            <input type="hidden" id="hdTextColorBoardIndex" value="1"/>
                                            <input type="hidden" id="hdBoardIndex" value="1"/>
                        ...
                        <tr>
                            <td width="500" height="44" align="right" style="border-width: 1px; border-top-color: rgb(229,233,235);
                                ...
                                <table cellpadding="0" cellspacing="0" align="center" width="485">
                                    <tr>
                                        <td width="485" height="41" align="right">
                                            <input type="hidden" id="hdBGMColorIndex" value="0"/>
                                            <input type="hidden" id="hdBGMModeIndex" value="0"/>
